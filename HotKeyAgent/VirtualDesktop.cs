    ...
    */
    ...
    public class Desktop
    {
        ...
        { // compare with object
            ...
            return desk != null && object.ReferenceEquals(ivd, desk.ivd);
        }
        ...
        { // set name for desktop, empty string removes names
            ...
            { // only if interface to set name is present
                DesktopManager.VirtualDesktopManagerInternal2.SetName(ivd, Name);
            }
        }
        ...
        { // return desktop at the left of this one, null if none
            get
            {
                int hr = DesktopManager.VirtualDesktopManagerInternal.GetAdjacentDesktop(ivd, 3, out IVirtualDesktop desktop); // 3 = LeftDirection
                if (hr == 0)
                {
        ...
        { // return desktop at the right of this one, null if none
            get
            {
                int hr = DesktopManager.VirtualDesktopManagerInternal.GetAdjacentDesktop(ivd, 4, out IVirtualDesktop desktop); // 4 = RightDirection
                if (hr == 0)
                {
                    return new Desktop(desktop);
                }
        ...
        { // pin window to all desktops
            ...
            IApplicationView view = hWnd.GetApplicationView();
...
namespace VDeskTool
{
    internal static class Program1
    {
        ...
        private static bool breakonerror = true;
        private static bool wrapdesktops = false;
                    ...
                    { // parameter without value
                        switch (groups[1].Value.ToUpper())
                        {
                            ...
                            case "GCD":
                                ...
                                if (verbose)
                                {
                                    Console.WriteLine("Current desktop: '" + VirtualDesktop.Desktop.DesktopNameFromDesktop(VirtualDesktop.Desktop.Current) + "' (desktop number " + rc + ")");
                                }
                            ...
                            case "IV":
                                ...
                                { // check if parameter is 0 and in range of active desktops
                                    if (VirtualDesktop.Desktop.FromIndex(rc).IsVisible)
                                    {
                                        if (verbose)
                                        {
                                            Console.WriteLine("Virtual desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "' (desktop number " + rc.ToString() + ") is visible");
                                        }
                                    ...
                                    else
                                    {
                                        if (verbose)
                                        {
                                            Console.WriteLine("Virtual desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "' (desktop number " + rc.ToString() + ") is not visible");
                                        }
                            ...
                            case "S":
                                if (verbose)
                                {
                                    Console.Write("Switching to virtual desktop number " + rc.ToString());
                                }
                                ...
                                { // activate virtual desktop rc
                                    ...
                                    if (verbose)
                                    {
                                        Console.WriteLine(", desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "' is active now");
                                    }
                                }
                                catch
                            ...
                            case "L":
                                ...
                                { // activate virtual desktop to the left
                                    ...
                                    if (verbose)
                                    {
                                        Console.WriteLine(", desktop number " + rc.ToString() + " ('" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "') is active now");
                                    }
                                }
                                catch
                                { // error while activating
                            ...
                            case "NA":
                                ...
                                { // remove desktop name
                                    ...
                                    if (verbose)
                                    {
                                        Console.WriteLine("Removed name of desktop number " + rc.ToString());
                                    }
                                }
                                catch
                            ...
                            case "R":
                                if (verbose)
                                {
                                    ...
                                    if ((rc >= 0) && (rc < VirtualDesktop.Desktop.Count))
                                    {
                                        Console.WriteLine(" (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "')");
                                    }
                                }
                                try
                            ...
                            case "MAW":
                                if (verbose)
                                {
                                    Console.WriteLine("Moving active window to virtual desktop number " + rc.ToString());
                                }
                                ...
                                { // move active window
                                    ...
                                    if (verbose)
                                    {
                                        Console.WriteLine("Active window moved to desktop number " + rc.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "')");
                                    }
                                }
                                catch
                                { // error while moving
                        ...
                        switch (groups[1].Value.ToUpper())
                        {
                            ...
                            case "GD":
                                ...
                                { // parameter is an integer, use as desktop number
                                    ...
                                    { // check if parameter is 0 and in range of active desktops
                                        if (verbose)
                                        {
                                            Console.WriteLine("Virtual desktop number " + iParam.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(iParam) + "') selected");
                                        }
                                ...
                                { // parameter is a string, search as part of desktop name
                                    ...
                                    { // no desktop found
                                        if (verbose)
                                        {
                                            Console.WriteLine("Could not find virtual desktop with name containing '" + groups[2].Value + "'");
                                        }
                                ...
                                { // parameter is an integer, use as desktop number
                                    ...
                                    { // check if parameter is 0 and in range of active desktops
                                        if (VirtualDesktop.Desktop.FromIndex(iParam).IsVisible)
                                        {
                                            if (verbose)
                                            {
                                                Console.WriteLine("Virtual desktop number " + iParam.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(iParam) + "') is visible");
                                            }
                                        ...
                                        else
                                        {
                                            if (verbose)
                                            {
                                                Console.WriteLine("Virtual desktop number " + iParam.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(iParam) + "') is not visible");
                                            }
                            ...
                            case "NA":
                                ...
                                { // set desktop name
                                    ...
                                    if (verbose)
                                    {
                                        Console.WriteLine("Set name of desktop number " + rc.ToString() + " to '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "'");
                                    }
                                }
                                catch
                                { // error while setting name
                                    if (verbose)
                                    {
                                        Console.WriteLine("Error setting desktop name to '" + groups[2].Value + "'");
                                    }
                            ...
                            case "S":
                                ...
                                { // parameter is an integer, use as desktop number
                                    ...
                                    { // check if parameter is 0 and in range of active desktops
                                        if (verbose)
                                        {
                                            Console.WriteLine("Switching to virtual desktop number " + iParam.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(iParam) + "')");
                                        }
                            ...
                            case "R":
                                ...
                                { // parameter is an integer, use as desktop number
                                    ...
                                    { // check if parameter is 0 and in range of active desktops
                                        if (verbose)
                                        {
                                            Console.WriteLine("Removing virtual desktop number " + iParam.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(iParam) + "')");
                                        }
                            ...
                            case "GDFW":
                                ...
                                { // check if parameter is an integer
                                    ...
                                    { // check if parameter is greater than 0
                                        ...
                                        { // seeking desktop for process handle
                                            ...
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window is on desktop number " + rc.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "')");
                                            }
                                        }
                                        catch
                                        { // error while seeking
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window to process id " + groups[2].Value + "' not found");
                                            }
                                ...
                                else
                                {
                                    ...
                                    { // seeking desktop for process name
                                        ...
                                        if (verbose)
                                        {
                                            Console.WriteLine("Window of process '" + groups[2].Value + "' is on desktop number " + rc.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "')");
                                        }
                                    }
                                    catch
                                    { // error while seeking
                                        if (verbose)
                                        {
                                            Console.WriteLine("Process '" + groups[2].Value + "' not found");
                                        }
                            ...
                            case "GDFWH":
                                ...
                                { // check if parameter is an integer
                                    ...
                                    { // check if parameter is greater than 0
                                        ...
                                        { // error while seeking
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window to handle " + groups[2].Value + "' not found");
                                            }
                                ...
                                else
                                {
                                    ...
                                    { // seeking window with window title
                                        iParam = (int)GetWindowFromTitle(groups[2].Value.Trim().Replace("^", ""));
                                        // seeking desktop for window handle
                                        rc = VirtualDesktop.Desktop.FromDesktop(VirtualDesktop.Desktop.FromWindow((IntPtr)iParam));
                                        if (verbose)
                                        {
                                            Console.WriteLine("Window '" + foundTitle + "' is on desktop number " + rc.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "')");
                                        }
                                    }
                                    catch
                                    { // error while seeking
                                        if (verbose)
                                        {
                                            Console.WriteLine("Window with text '" + groups[2].Value + "' in title not found");
                                        }
                                    ...
                                    { // check if parameter is greater than 0
                                        ...
                                        { // checking desktop for process handle
                                            ...
                                            if (VirtualDesktop.Desktop.FromIndex(rc).HasWindow((IntPtr)iParam))
                                            {
                                                if (verbose)
                                                {
                                                    Console.WriteLine("Window to process id " + groups[2].Value + " is on desktop number " + rc.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "')");
                                                }
                                            ...
                                            else
                                            {
                                                if (verbose)
                                                {
                                                    Console.WriteLine("Window to process id " + groups[2].Value + " is not on desktop number " + rc.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "')");
                                                }
                                ...
                                else
                                {
                                    ...
                                    { // seeking desktop for process name
                                        ...
                                        else
                                        {
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window of process '" + groups[2].Value + "' is not on desktop number " + rc.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "')");
                                            }
                                    ...
                                    { // check if parameter is greater than 0
                                        ...
                                        { // checking desktop for window handle
                                            if (VirtualDesktop.Desktop.FromIndex(rc).HasWindow((IntPtr)iParam))
                                            {
                                                if (verbose)
                                                {
                                                    Console.WriteLine("Window to handle " + groups[2].Value + " is on desktop number " + rc.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "')");
                                                }
                                            ...
                                            else
                                            {
                                                if (verbose)
                                                {
                                                    Console.WriteLine("Window to handle " + groups[2].Value + " is not on desktop number " + rc.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "')");
                                                }
                                ...
                                else
                                {
                                    ...
                                    { // seeking window with window title
                                        ...
                                        else
                                        {
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window '" + foundTitle + "' is not on desktop number " + rc.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "')");
                                            }
                            ...
                            case "MW":
                                ...
                                { // check if parameter is an integer
                                    ...
                                    { // check if parameter is greater than 0
                                        ...
                                        { // seeking window for process handle
                                            ...
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window to process id " + groups[2].Value + " moved to desktop number " + rc.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "')");
                                            }
                                        }
                                        catch
                                        { // error while seeking
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window to process id " + groups[2].Value + " not found or move failed");
                                            }
                                ...
                                else
                                {
                                    ...
                                    { // seeking window for process name
                                        ...
                                        if (verbose)
                                        {
                                            Console.WriteLine("Window of process '" + groups[2].Value + "' moved to desktop number " + rc.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "')");
                                        }
                                    }
                                    catch
                                    { // error while seeking
                                        if (verbose)
                                        {
                                            Console.WriteLine("Process '" + groups[2].Value + "' not found or move failed");
                                        }
                            ...
                            case "MWH":
                                ...
                                { // check if parameter is an integer
                                    ...
                                    { // check if parameter is greater than 0
                                        try
                                        {
                                            ...
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window to handle " + groups[2].Value + " moved to desktop number " + rc.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "')");
                                            }
                                        }
                                        catch
                                        { // error while seeking
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window to handle " + groups[2].Value + " not found or move failed");
                                            }
                                ...
                                else
                                {
                                    ...
                                    { // seeking window with window title
                                        ...
                                        if (verbose)
                                        {
                                            Console.WriteLine("Window '" + foundTitle + "' moved to desktop number " + rc.ToString() + " (desktop '" + VirtualDesktop.Desktop.DesktopNameFromIndex(rc) + "')");
                                        }
                                    }
                                    catch
                                    { // error while seeking
                                        if (verbose)
                                        {
                                            Console.WriteLine("Window with text '" + groups[2].Value + "' in title not found or move failed");
                                        }
                                    ...
                                    { // check if parameter is greater than 0
                                        ...
                                        { // checking desktop for process handle
                                            ...
                                            if (VirtualDesktop.Desktop.IsWindowPinned((IntPtr)iParam))
                                            {
                                                if (verbose)
                                                {
                                                    Console.WriteLine("Window to process id " + groups[2].Value + " is pinned to all desktops");
                                                }
                                            ...
                                            else
                                            {
                                                if (verbose)
                                                {
                                                    Console.WriteLine("Window to process id " + groups[2].Value + " is not pinned to all desktops");
                                                }
                                ...
                                else
                                {
                                    ...
                                    { // seeking desktop for process name
                                        ...
                                        if (VirtualDesktop.Desktop.IsWindowPinned((IntPtr)iParam))
                                        {
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window of process '" + groups[2].Value + "' is pinned to all desktops");
                                            }
                                        ...
                                        else
                                        {
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window of process '" + groups[2].Value + "' is not pinned to all desktops");
                                            }
                                    ...
                                    { // check if parameter is greater than 0
                                        ...
                                        { // checking desktop for window handle
                                            if (VirtualDesktop.Desktop.IsWindowPinned((IntPtr)iParam))
                                            {
                                                if (verbose)
                                                {
                                                    Console.WriteLine("Window to handle " + groups[2].Value + " is pinned to all desktops");
                                                }
                                            ...
                                            else
                                            {
                                                if (verbose)
                                                {
                                                    Console.WriteLine("Window to handle " + groups[2].Value + " is not pinned to all desktops");
                                                }
                                ...
                                else
                                {
                                    ...
                                    { // seeking window with window title
                                        ...
                                        if (VirtualDesktop.Desktop.IsWindowPinned((IntPtr)iParam))
                                        {
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window '" + foundTitle + "' is pinned to all desktops");
                                            }
                                        ...
                                        else
                                        {
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window '" + foundTitle + "' is not pinned to all desktops");
                                            }
                            ...
                            case "PW":
                                ...
                                { // check if parameter is an integer
                                    ...
                                    { // check if parameter is greater than 0
                                        ...
                                        { // seeking window for process handle
                                            ...
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window to process id " + groups[2].Value + " pinned to all desktops");
                                            }
                                        }
                                        catch
                                        { // error while seeking
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window to process id " + groups[2].Value + " not found or pin failed");
                                            }
                                ...
                                else
                                {
                                    ...
                                    { // seeking window for process name
                                        ...
                                        if (verbose)
                                        {
                                            Console.WriteLine("Window of process '" + groups[2].Value + "' pinned to all desktops");
                                        }
                                    }
                                    catch
                                    { // error while seeking
                                        if (verbose)
                                        {
                                            Console.WriteLine("Process '" + groups[2].Value + "' not found or pin failed");
                                        }
                            ...
                            case "PWH":
                                ...
                                { // check if parameter is an integer
                                    ...
                                    { // check if parameter is greater than 0
                                        ...
                                        { // process window handle and pin window
                                            ...
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window to handle " + groups[2].Value + " pinned to all desktops");
                                            }
                                        }
                                        catch
                                        { // error while seeking
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window to handle " + groups[2].Value + " not found or pin failed");
                                            }
                                ...
                                else
                                {
                                    ...
                                    { // seeking window with window title
                                        ...
                                        if (verbose)
                                        {
                                            Console.WriteLine("Window '" + foundTitle + "' pinned to all desktops");
                                        }
                                    }
                                    catch
                                    { // error while seeking
                                        if (verbose)
                                        {
                                            Console.WriteLine("Window with text '" + groups[2].Value + "' in title not found or pin failed");
                                        }
                            ...
                            case "UPW":
                                ...
                                { // check if parameter is an integer
                                    ...
                                    { // check if parameter is greater than 0
                                        ...
                                        { // seeking window for process handle
                                            ...
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window to process id " + groups[2].Value + " unpinned from all desktops");
                                            }
                                        }
                                        catch
                                        { // error while seeking
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window to process id " + groups[2].Value + " not found or unpin failed");
                                            }
                                ...
                                else
                                {
                                    ...
                                    { // seeking window for process name
                                        ...
                                        if (verbose)
                                        {
                                            Console.WriteLine("Window of process '" + groups[2].Value + "' unpinned from all desktops");
                                        }
                                    }
                                    catch
                                    { // error while seeking
                                        if (verbose)
                                        {
                                            Console.WriteLine("Process '" + groups[2].Value + "' not found or unpin failed");
                                        }
                            ...
                            case "UPWH":
                                ...
                                { // check if parameter is an integer
                                    ...
                                    { // check if parameter is greater than 0
                                        ...
                                        { // process window handle and unpin window
                                            ...
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window to handle " + groups[2].Value + " unpinned from all desktops");
                                            }
                                        }
                                        catch
                                        { // error while seeking
                                            if (verbose)
                                            {
                                                Console.WriteLine("Window to handle " + groups[2].Value + " not found or unpin failed");
                                            }
                                ...
                                else
                                {
                                    ...
                                    { // seeking window with window title
                                        ...
                                        if (verbose)
                                        {
                                            Console.WriteLine("Window '" + foundTitle + "' unpinned from all desktops");
                                        }
                                    }
                                    catch
                                    { // error while seeking
                                        if (verbose)
                                        {
                                            Console.WriteLine("Window with text '" + groups[2].Value + "' in title not found or unpin failed");
                                        }
                                    ...
                                    { // check if parameter is greater than 0
                                        ...
                                        { // checking desktop for process handle
                                            ...
                                            if (VirtualDesktop.Desktop.IsApplicationPinned((IntPtr)iParam))
                                            {
                                                if (verbose)
                                                {
                                                    Console.WriteLine("Application to process id " + groups[2].Value + " is pinned to all desktops");
                                                }
                                            ...
                                            else
                                            {
                                                if (verbose)
                                                {
                                                    Console.WriteLine("Application to process id " + groups[2].Value + " is not pinned to all desktops");
                                                }
                                ...
                                else
                                {
                                    ...
                                    { // seeking desktop for process name
                                        ...
                                        if (VirtualDesktop.Desktop.IsApplicationPinned((IntPtr)iParam))
                                        {
                                            if (verbose)
                                            {
                                                Console.WriteLine("Application of process '" + groups[2].Value + "' is pinned to all desktops");
                                            }
                                        ...
                                        else
                                        {
                                            if (verbose)
                                            {
                                                Console.WriteLine("Application of process '" + groups[2].Value + "' is not pinned to all desktops");
                                            }
                            ...
                            case "PA":
                                ...
                                { // check if parameter is an integer
                                    ...
                                    { // check if parameter is greater than 0
                                        ...
                                        { // seeking window for process handle
                                            ...
                                            if (verbose)
                                            {
                                                Console.WriteLine("Application to process id " + groups[2].Value + " pinned to all desktops");
                                            }
                                        }
                                        catch
                                        { // error while seeking
                                ...
                                else
                                {
                                    ...
                                    { // seeking window for process name
                                        ...
                                        if (verbose)
                                        {
                                            Console.WriteLine("Application of process '" + groups[2].Value + "' pinned to all desktops");
                                        }
                                    }
                                    catch
                                    { // error while seeking
                            ...
                            case "UPA":
                                ...
                                { // check if parameter is an integer
                                    ...
                                    { // check if parameter is greater than 0
                                        ...
                                        { // seeking window for process handle
                                            ...
                                            if (verbose)
                                            {
                                                Console.WriteLine("Application to process id " + groups[2].Value + " unpinned from all desktops");
                                            }
                                        }
                                        catch
                                        { // error while seeking
                                ...
                                else
                                {
                                    ...
                                    { // seeking window for process name
                                        ...
                                        if (verbose)
                                        {
                                            Console.WriteLine("Application of process '" + groups[2].Value + "' unpinned from all desktops");
                                        }
                                    }
                                    catch
                                    { // error while seeking
                            ...
                            case "SL":
                                ...
                                { // check if parameter is an integer
                                    ...
                                    { // check if parameter is greater than 0
                                        if (verbose)
                                        {
                                            Console.WriteLine("Waiting " + iParam.ToString() + "ms");
                                        }
        ...
        private static int GetMainWindowHandle(string ProcessName)
